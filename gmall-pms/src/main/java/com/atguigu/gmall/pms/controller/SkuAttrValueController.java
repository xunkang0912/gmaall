...
public class SkuAttrValueController {
    ...
    public ResponseVo<List<SkuAttrValueEntity>> querySearchSkuAttrValuesBySkuIdAndCid(
            @PathVariable("skuId")Long skuId,
            @RequestParam("cid")Long cid
    ){
        List<SkuAttrValueEntity> skuAttrValueEntities = this.skuAttrValueService.querySearchSkuAttrValuesBySkuIdAndCid(skuId, cid);
